...
'use strict';
angular.module('myApp').factory('OrderDispatchService', ['$http', '$q','$cookies', function($http, $q,$cookies){

    var REST_GET_ORDERS_URI = serverurl+'/orders/forstore';
    var REST_GET_FILTERED_ORDERS_URI = serverurl+'/orders/forstore?page=';
    var REST_SALE_DELIVER_URI = serverurl+'/orders/deliverOrderItemFromStore';
