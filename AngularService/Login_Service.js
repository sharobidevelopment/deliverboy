...
angular.module('myApp').factory('LoginService', ['$http', '$q','$cookies', function($http, $q,$cookies){
    ...
    var REST_LOGIN_SERVICE_URI = serverurl+'/delivery/login';
    ...
    function loginRequest(user) {
        ...
        user.loginType = "DELIVERY_PERSON";
        console.log("login credential "+ JSON.stringify(user));
        $http.post(REST_LOGIN_SERVICE_URI, user)
            .then(
            function (response) {
                console.log('No Error while login User');
